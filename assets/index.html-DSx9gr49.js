import{_ as i,c as n,a,o as l}from"./app-DGnjmf92.js";const e={};function p(d,s){return l(),n("div",null,s[0]||(s[0]=[a(`<p>RK3588标称解码能力为</p><ul><li>h264 8K@30fps</li><li>h265 8K@60fps</li></ul><p>提供了适配了 Rockchip MPP (Media Process Platform，rockchip中的硬件解码器的ffmpeg https://github.com/nyanmisaka/ffmpeg-rockchip</p><h1 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h1><p>ffmpeg-rockchip 中提供了<a href="https://github.com/nyanmisaka/ffmpeg-rockchip/wiki/Compilation" target="_blank" rel="noopener noreferrer">安装方法</a>, 但是感觉写的不够清楚，他的意思是要先去找官方教程上的依赖安装部分，安装所需的依赖，(ffmpeg为编解码器提供了统一的接口，在安装教程中出现了多种编解码库的安装，是可选的，对于rk平台，我们肯定是为了使用硬件解码器，因此我们可以一个也不用安装)</p><p>以Vim2 edge2 ubuntu20.04为例，我成功的版本如下:</p><div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;"># 安装依赖</span></span>
